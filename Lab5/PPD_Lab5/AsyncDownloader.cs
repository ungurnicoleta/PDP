...
namespace PPD_Lab5
{
    ...
    {
        public AsyncDownloader(string url, int port = 80)
        {
            this.Url = url;
            this.Port = port;
        ...
        private async Task ConnectWrapper(StateObject state) {
        ...
        private async Task SendWrapper(StateObject state, string data) {  
        ...
        private async Task ReceiveWrapper(StateObject state) {
